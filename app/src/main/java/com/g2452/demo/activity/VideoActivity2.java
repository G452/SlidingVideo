...
import com.g2452.demo.adapter.ViewPagerAdapter;
...
import com.g2452.demo.util.SharedPreferencesUtil;
import com.g2452.demo.view.EmptyControlVideo;
import com.g2452.demo.view.VerticalViewPager;
import com.shuyu.gsyvideoplayer.GSYVideoManager;

import java.util.ArrayList;


public class VideoActivity2<M extends Icontract.Model, V extends Icontract.View, P extends Icontract.Persenter> extends BaseActivity {
    ...
    private VideoPkAdapter videoAdapter1;
    private VideoPkAdapter2 videoAdapter2;
    ...
    public void initView() {
        ...
        videoAdapter1 = new VideoPkAdapter(mContext);
        videoAdapter2 = new VideoPkAdapter2(mContext);
    ...
    private void RecyclerViewListener() {
        /*首次播放*/
        videoAdapter1.setFirstPlaykLinter(new VideoPkAdapter.OnFirstPlayLintener() {
            @Override
