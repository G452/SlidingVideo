 ...
 * 概述：
 */
public class VideoPkAdapter_zy1 extends BaseRecycleAdapter<VideoBean> {
    ...
    public VideoPkAdapter_zy1(Context context) {
        super(context);
    ...
    protected void convert(BaseViewHolder holder, VideoBean videoBean, int postion) {
        ...
        layoutParams.width = displayMetrics.widthPixels/2-50;
